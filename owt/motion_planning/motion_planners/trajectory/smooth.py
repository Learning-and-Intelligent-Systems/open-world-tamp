...
from ..utils import (INF, default_selector, elapsed_time, find, get_pairs,
                     irange, waypoints_from_path)
from .discretize import (derivative_discretize_curve,
...
from .retime import (EPSILON, append_polys, find_extrema, get_interval,
                     spline_duration, trim)
