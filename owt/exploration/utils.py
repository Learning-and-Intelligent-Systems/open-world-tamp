...
def get_pointcloud_from_camera_image(camera_image):
    ...
    rgbd = o3d.geometry.RGBDImage.create_from_color_and_depth(
        rgb_image, depth_image, depth_trunc=1000, convert_rgb_to_intensity=False
    )
...
def get_viewcone_base(depth=5, camera_matrix=None):
    ...
    width, height = pbu.dimensions_from_camera_matrix(camera_matrix)
    vertices = []
    for pixel in [(0, 0), (width, 0), (width, height), (0, height)]:
        ray = depth * pbu.ray_from_pixel(camera_matrix, pixel)
