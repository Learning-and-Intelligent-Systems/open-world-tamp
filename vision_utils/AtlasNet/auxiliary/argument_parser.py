...
def parser():
    ...
    parser.add_argument(
        "--random_seed", action="store_true", help="Fix random seed or not"
    )
    ...
    parser.add_argument(
        "--random_rotation",
        action="store_true",
        help="apply data augmentation : random rotation",
    )
    parser.add_argument(
        "--data_augmentation_axis_rotation",
        action="store_true",
        help="apply data augmentation : axial rotation ",
    )
    parser.add_argument(
        "--data_augmentation_random_flips",
        action="store_true",
    ...
    parser.add_argument(
        "--demo_input_path",
        type=str,
        default="./doc/pictures/plane_input_demo.png",
        help="dirname",
    )
    parser.add_argument("--reload_decoder_path", type=str, default="", help="dirname")
    parser.add_argument(
        "--reload_model_path", type=str, default="", help="optional reload model path"
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Replace all batchnorms by identity",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="relu",
        choices=["relu", "sigmoid", "softplus", "logsigmoid", "softsign", "tanh"],
        help="dim_out_patch",
    )

    # Loss
    parser.add_argument(
        "--no_metro", action="store_true", help="Compute metro distance"
    )
    ...
    if opt.demo or opt.run_single_eval:
        if not exists(
            "./training/trained_models/atlasnet_singleview_25_squares/network.pth"
        ):
