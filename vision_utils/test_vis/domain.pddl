(define (domain pr2-tamp)
  ...
  ;(:action observe-specific
  ;  :parameters (?obj ?pobj ?vs)
  ;  :precondition (and  (Registered ?obj) (AtPose ?obj ?pobj)
  ;                      ;(not (PoseCertain ?obj))
  ;                      (Visible ?vs)
  ;                )
  ;  :effect (and  (PoseCertain ?obj)
  ;                (increase (total-cost) (ScanCost))
  ;          )
  ;)
